...
from cameras.realsense import read_rs_camera

from PIL import Image

def transformed_image_stream(queue, imagedir, backbone, stride, skip=0):
    ...
    for t, imfile in enumerate(image_list):
        rgb = transform(Image.open(str(imfile))).numpy()
        queue.put((t, rgb, str(imfile)))
...
def image_stream(queue, imagedir, calib, stride, skip=0):
    ...
    # print("DEBUG: Loading calib intrinsics from :", calib)
